...
const HARPER_TOOLS=[
  ...
  {title:'Music Theory course',view:'theory',desc:'A five-unit Music Theory course — fundamentals, harmony, chromatic harmony, counterpoint, and the science of sound — every lesson mapped to the lever harp.',text:'four semester music theory course plus the science of sound, fundamentals harmony chromatic counterpoint jazz acoustics tuning'},
