...
const SHAMAYIM_SOURCE = 'A contemplative journey · The Harp Project, Edenrise. Scripture: JPS 1917 translation (public domain), via Sefaria. Science is cited from established research; where a parallel between tradition and physics is poetic rather than proven, it is marked as such. All scholarship is cited and linked to its authors, taught in our own words.';
...
const SHAMAYIM_LEVELS = [
  {
    ...
    blocks:[
      ...
      {k:'prose', text:'Above them all stands one figure: <b>David</b>, the shepherd-king remembered as <i>"the sweet singer of Israel"</i> (2 Samuel 23:1). Scripture traces his musical identity as it grows — the skilful harpist of the book of Samuel, the great organiser of Temple song in Chronicles, and the voice behind the <b>Psalms</b>. It is largely through David that the harp became, for so many, the very sound of the soul turned toward God.'},
      {k:'scripture', ref:'Psalm 150:3–4', heb:'הַלְלוּהוּ בְּתֵקַע שׁוֹפָר · הַלְלוּהוּ בְּנֵבֶל וְכִנּוֹר', text:'Praise Him with the blast of the horn; praise Him with the psaltery and harp. Praise Him with the timbrel and dance; praise Him with stringed instruments and the pipe.'},
  ...
  },
  {
    ...
    blocks:[
      ...
      {k:'scripture', ref:'1 Samuel 16:23', heb:'וְלָקַח דָּוִד אֶת־הַכִּנּוֹר וְנִגֵּן בְּיָדוֹ', text:'And it came to pass, when the evil spirit from God was upon Saul, that David took the harp, and played with his hand; so Saul found relief, and it was well with him, and the evil spirit departed from him.'},
  ...
  },
  {
    ...
    blocks:[
      ...
      {k:'scripture', ref:'Psalm 42:7', heb:'תְּהוֹם אֶל־תְּהוֹם קוֹרֵא לְקוֹל צִנּוֹרֶיךָ', text:'Deep calleth unto deep at the voice of Thy cataracts; all Thy waves and Thy billows are gone over me.'},
  ...
  },
  {
    ...
    blocks:[
      ...
      {k:'scripture', ref:'Psalm 19:1–4', heb:'הַשָּׁמַיִם מְסַפְּרִים כְּבוֹד־אֵל · וּמַעֲשֵׂה יָדָיו מַגִּיד הָרָקִיעַ', text:'The heavens declare the glory of God, and the firmament showeth His handiwork; day unto day uttereth speech, and night unto night revealeth knowledge; there is no speech, there are no words, neither is their voice heard; their line is gone out through all the earth, and their words to the end of the world.'},
...
const SHAMAYIM_SOURCES = {
  ...
  groups:[
    { t:'Scripture & tradition', items:[
      ...
      {k:'read', label:'The Tanakh (JPS 1917, public domain) with cantillation', by:'Sefaria', url:'https://www.sefaria.org'},
    ]},
    { t:'David, the sweet singer', items:[
      {k:'read', label:'“The Sweet Singer of Israel”: David as Musician', by:'Amanda Kleinman, HUC-JIR (2015) — cited, not reproduced', url:'https://www.huc.edu/'},
      {k:'read', label:'The Music of the Bible Revealed (a disputed reconstruction)', by:'Suzanne Haïk-Vantoura — cited as one contested theory', url:'https://en.wikipedia.org/wiki/Suzanne_Ha%C3%AFk-Vantoura'},
    ]},
