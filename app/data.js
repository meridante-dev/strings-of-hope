...
const VERSES = [
  ...
  {ref:'Psalm 33:2',  heref:'תהילים לג:ב', he:'הודו ליהוה בכנור בנבל עשור זמרו לו', tr:'Hodu la’Adonai b’chinor, b’nevel asor zamru lo.', text:'Give thanks unto the LORD with harp; sing praises unto Him with the psaltery of ten strings.'},
  {ref:'Psalm 150:4', heref:'תהילים קנ:ד', he:'הללוהו בתף ומחול הללוהו במנים ועגב', tr:'Hal’luhu b’tof u’machol, hal’luhu b’minim v’ugav.', text:'Praise Him with the timbrel and dance; praise Him with stringed instruments and the pipe.'},
  {ref:'Psalm 57:8',  heref:'תהילים נז:ח', he:'עורה כבודי עורה הנבל וכנור אעירה שחר', tr:'Urah k’vodi, urah ha’nevel v’chinor, a’irah shachar.', text:'Awake, my glory; awake, psaltery and harp; I will awake the dawn.'},
  {ref:'Psalm 92:1‑3',heref:'תהילים צב:א-ג', he:'טוב להדות ליהוה ולזמר לשמך עליון', tr:'Tov l’hodot la’Adonai, u’lzamer l’shimcha Elyon.', text:'It is a good thing to give thanks unto the LORD, and to sing praises unto Thy name, O Most High.'},
  {ref:'Psalm 30:11', heref:'תהילים ל:יא', he:'הפכת מספדי למחול לי פתחת שקי ותאזרני שמחה', tr:'Hafachta mispdi l’machol li, pitachta saki vat’azreni simcha.', text:'Thou didst turn for me my mourning into dancing; Thou didst loose my sackcloth, and gird me with gladness.'},
  ...
  {ref:'Psalm 118:24',heref:'תהילים קיח:כד', he:'זה היום עשה יהוה נגילה ונשמחה בו', tr:'Zeh ha’yom asah Adonai, nagilah v’nismecha vo.', text:'This is the day which the LORD hath made; we will rejoice and be glad in it.'},
  {ref:'Psalm 16:11', heref:'תהילים טז:יא', he:'תודיעני ארח חיים שבע שמחות את פניך', tr:'Todi’eni orach chayim, sova s’machot et panecha.', text:'Thou makest me to know the path of life; in Thy presence is fulness of joy.'},
  {ref:'Psalm 119:105',heref:'תהילים קיט:קה', he:'נר לרגלי דברך ואור לנתיבתי', tr:'Ner l’ragli d’varecha, v’or lin’tivati.', text:'Thy word is a lamp unto my feet, and a light unto my path.'},
  {ref:'Psalm 23:4', heref:'תהילים כג:ד', he:'גם כי אלך בגיא צלמות לא אירא רע כי אתה עמדי', tr:'Gam ki elech b’gei tzalmavet, lo ira ra, ki Atah imadi.', text:'Yea, though I walk through the valley of the shadow of death, I will fear no evil, for Thou art with me.'},
  {ref:'Psalm 34:8', heref:'תהילים לד:ח', he:'טעמו וראו כי טוב יהוה אשרי הגבר יחסה בו', tr:'Ta’amu u’r’u ki tov Adonai, ashrei ha’gever yecheseh bo.', text:'O taste and see that the LORD is good; blessed is the man that taketh refuge in Him.'},
  {ref:'Psalm 37:4', heref:'תהילים לז:ד', he:'והתענג על יהוה ויתן לך משאלת לבך', tr:'V’hit’anag al Adonai, v’yiten l’cha mish’alot libecha.', text:'Delight thyself in the LORD; and He will give thee the desires of thy heart.'},
  ...
  {ref:'Psalm 121:1',heref:'תהילים קכא:א', he:'אשא עיני אל ההרים מאין יבא עזרי', tr:'Esa einai el he’harim, me’ayin yavo ezri.', text:'I will lift up mine eyes unto the mountains: from whence shall my help come?'},
  {ref:'Psalm 126:5',heref:'תהילים קכו:ה', he:'הזרעים בדמעה ברנה יקצרו', tr:'Ha’zor’im b’dim’ah b’rinah yiktzoru.', text:'They that sow in tears shall reap in joy.'},
  {ref:'Psalm 147:3',heref:'תהילים קמז:ג', he:'הרפא לשבורי לב ומחבש לעצבותם', tr:'Ha’rofei lish’vurei lev, u’mchabesh l’atzvotam.', text:'He healeth the broken in heart, and bindeth up their wounds.'},
  {ref:'Isaiah 40:31', heref:'ישעיהו מ:לא', he:'וקוי יהוה יחליפו כח יעלו אבר כנשרים', tr:'V’kovei Adonai yachalifu cho’ach, ya’alu ever ka’n’sharim.', text:'They that wait for the LORD shall renew their strength; they shall mount up with wings as eagles.'},
  {ref:'Isaiah 12:2',  heref:'ישעיהו יב:ב', he:'כי עזי וזמרת יה יהוה ויהי לי לישועה', tr:'Ki ozi v’zimrat Yah Adonai, vay’hi li li’shuah.', text:'For God the LORD is my strength and song; and He is become my salvation.'},
  {ref:'Isaiah 41:10', heref:'ישעיהו מא:י', he:'אל תירא כי עמך אני אל תשתע כי אני אלהיך', tr:'Al tira ki im’cha Ani, al tishta ki Ani Elohecha.', text:'Fear thou not, for I am with thee; be not dismayed, for I am thy God.'},
  {ref:'Jeremiah 29:11',heref:'ירמיהו כט:יא', he:'כי אנכי ידעתי את המחשבת אשר אנכי חשב עליכם', tr:'Ki Anochi yadati et ha’machashavot asher Anochi choshev aleichem.', text:'For I know the thoughts that I think toward you, saith the LORD, thoughts of peace, and not of evil, to give you a future and a hope.'},
  {ref:'Zephaniah 3:17',heref:'צפניה ג:יז', he:'ישיש עליך בשמחה יחריש באהבתו יגיל עליך ברנה', tr:'Yasis alayich b’simcha, yacharish b’ahavato, yagil alayich b’rinah.', text:'He will rejoice over thee with joy, He will be silent in His love, He will joy over thee with singing.'},
  {ref:'Lamentations 3:22‑23',heref:'איכה ג:כב-כג', he:'חדשים לבקרים רבה אמונתך', tr:'Chadashim la’b’karim, rabah emunatecha.', text:'They are new every morning; great is Thy faithfulness.'},
  {ref:'Proverbs 3:5',  heref:'משלי ג:ה', he:'בטח אל יהוה בכל לבך ואל בינתך אל תשען', tr:'B’tach el Adonai b’chol libecha, v’el binat’cha al tisha’en.', text:'Trust in the LORD with all thy heart, and lean not upon thine own understanding.'},
  {ref:'Deuteronomy 31:6',heref:'דברים לא:ו', he:'חזקו ואמצו אל תיראו כי יהוה אלהיך הוא ההלך עמך', tr:'Chizku v’imtzu, al tir’u, ki Adonai Elohecha Hu ha’holech imach.', text:'Be strong and of good courage, fear not; for the LORD thy God, He it is that doth go with thee.'},
  {ref:'Exodus 15:2',   heref:'שמות טו:ב', he:'עזי וזמרת יה ויהי לי לישועה', tr:'Ozi v’zimrat Yah, vay’hi li li’shuah.', text:'The LORD is my strength and song, and He is become my salvation.'},
  {ref:'Numbers 6:24‑26',heref:'במדבר ו:כד-כו', he:'יברכך יהוה וישמרך יאר יהוה פניו אליך ויחנך', tr:'Y’varech’cha Adonai v’yishmerecha, ya’er Adonai panav elecha vichuneka.', text:'The LORD bless thee, and keep thee; the LORD make His face to shine upon thee, and be gracious unto thee.'},
  {ref:'1 Samuel 16:23',heref:'שמואל א טז:כג', he:'ולקח דוד את הכנור ונגן בידו ורוח לשאול וטוב לו וסרה מעליו רוח הרעה', tr:'V’lakach David et ha’kinor v’nigen b’yado, v’ravach l’Shaul v’tov lo, v’sarah me’alav ru’ach ha’ra’ah.', text:'David took the harp, and played with his hand; so Saul found relief, and it was well with him, and the evil spirit departed from him.'},
  ...
  {ref:'Song of Songs 2:12',heref:'שיר השירים ב:יב', he:'הנצנים נראו בארץ עת הזמיר הגיע', tr:'Ha’nitzanim nir’u va’aretz, et ha’zamir higia.', text:'The flowers appear on the earth; the time of singing is come, and the voice of the turtle is heard in our land.'},
  {ref:'Habakkuk 3:19', heref:'חבקוק ג:יט', he:'יהוה אדני חילי וישם רגלי כאילות', tr:'Adonai Adonai cheili, vay’sem raglai ka’ayalot.', text:'God, the Lord, is my strength; He maketh my feet like hinds’, and maketh me to walk upon my high places.'},
  {ref:'Psalm 108:1',heref:'תהילים קח:א', he:'נכון לבי אלהים אשירה ואזמרה אף כבודי', tr:'Nachon libi Elohim, ashirah va’azamrah af k’vodi.', text:'My heart is stedfast, O God; I will sing, yea, I will sing praises, even with my glory.'},
];
