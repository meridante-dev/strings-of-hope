...
const JACOB_MODULES = [
  ...
  { n:8, title:'Beyond the 12 Notes', kicker:'Microtonality · candid',
    ...
    note:'These lessons adapt an openly-licensed chapter — <b>“Microtonality” by Justin Rubin</b> (Univ. of Minnesota, <b>CC BY 4.0</b>) — taught here in our own words and mapped to the harp. Read the original in <i>Go deeper</i>.',
    lessons:[
      { kick:'Learn', h:'The cracks between the keys',
        body:'Our 12 notes aren’t the only notes — they’re a <b>grid</b> laid over a smooth, continuous rainbow of pitch. <b>Equal temperament</b> chops the octave into 12 equal steps, and between any two of them live infinitely many <b>microtones</b>. We measure them in <b>cents</b>: 100 cents to a semitone, 1200 to an octave. A pitch 50 cents above C sits exactly halfway to C♯ — a <b>quarter-tone</b>, the most famous in-between note.',
        harp:'Your strings are 12 fixed pitches per octave — the grid itself. To <i>feel</i> a microtone, tune one spare string slightly flat by ear and let it ring against its neighbour: the slow shimmer you hear is the space between the keys made audible.' },
      { kick:'Learn', h:'Just intonation — nature’s own tuning',
        body:'Before equal temperament there was <b>just intonation</b>: tuning to the <b>pure ratios</b> of the harmonic series. A perfect fifth is exactly <b>3:2</b>, a major third exactly <b>5:4</b>. The catch — those pure intervals don’t fit neatly into 12 equal steps. A justly-tuned major third is about <b>14 cents flatter</b> than the piano’s, which is why a barbershop quartet or a choir can lock into a chord “more in tune” than any keyboard. “In tune” and “in tune with the piano” are two different things.',
        harp:'This is the flip-side of Module 7’s overtone series. On the harp, tune a chord <b>by ear</b> rather than to a machine and the thirds settle — beatless and glowing. That’s a real taste of just intonation on your own strings.' },
      { kick:'Learn', h:'Slicing the octave a different way',
        body:'If 12 is a choice, you can choose differently. <b>24 equal divisions</b> give quarter-tones (the backbone of Arabic and Turkish <i>maqam</i> music); <b>19</b> or <b>31 divisions</b> give sweeter thirds than 12 ever can. Jacob’s signature move is to <b>modulate to a key a quarter-tone away</b> — his “In the Bleak Midwinter” climbs into <b>G half-sharp</b>, and his “Moon River” lifts the whole song into a place “between the piano keys.” The ear follows, even though no keyboard could.',
        harp:'A lever harp can’t glide between the 12 live — but you <i>can</i> <b>retune chosen strings</b> before a piece to build a custom scale: a quarter-tone drone, a <i>maqam</i>-flavoured tetrachord. It’s slow, deliberate tuning rather than bending — but the colours are genuinely there.' },
      { kick:'Candid', h:'Where these notes really live',
        body:'The honest truth we owe you: the <b>diatonic lever harp lives in 12 notes and cannot bend pitch</b> mid-phrase. Jacob’s between-the-note magic belongs to instruments that glide — the voice, fretless strings, the trombone — and above all to <b>your ear</b>. But knowing the theory changes how you <b>listen</b>: you start to hear the 14-cent shimmer, the quarter-tone lift, the pure third singing inside a chord.',
        harp:'Train it: sing a note, then a <b>quarter-tone above</b> it, then check against a ringing string — hear how it floats between two “frets.” That listening is the real skill. The harp is your reference; your ear is the instrument.' },
    ],
